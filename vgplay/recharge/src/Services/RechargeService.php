...
namespace Vgplay\Recharges\Services;
...
class RechargeService
{
    ...
    public function getAll(bool $onlyActive = true): array
    {
        ...
        try {
            ...
            Log::error('RechargeService getAll failed', [
    ...
    public function search(string $keyword): array
    {
        ...
        try {
            ...
            Log::error('RechargeService search failed', [
                'keyword' => $keyword,
                'error' => $e->getMessage(),
            ]);
            return [];
    ...
    public function findById(int $id): ?array
    {
        ...
        try {
            ...
            Log::error('RechargeService findById failed', [
                'id' => $id,
                'error' => $e->getMessage(),
            ]);
            return null;
    ...
    public function findByAlias(string $alias): ?array
    {
        ...
        try {
            ...
            Log::error('RechargeService findByAlias failed', [
                'alias' => $alias,
                'error' => $e->getMessage(),
            ]);
            return null;
    ...
    public function syncAll(): void
    {
        ...
        try {
            ...
            Log::error('RechargeService syncAll failed', [
                'error' => $e->getMessage(),
            ]);
        }
    }
