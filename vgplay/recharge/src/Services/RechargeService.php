...
class Rechargeervice
{
    protected function cacheKey(string $suffix): string
    {
        return "recharge:{$suffix}";
    }
    ...
    //         });
    //     } catch (\Throwable $e) {
    //         Log::error('Rechargeervice getAll failed', [
    ...
    //         });
    //     } catch (\Throwable $e) {
    //         Log::error('Rechargeervice search failed', [
    //             'keyword' => $keyword,
    //             'error' => $e->getMessage(),
    //         ]);
    //         return [];
    ...
    //         });
    //     } catch (\Throwable $e) {
    //         Log::error('Rechargeervice findById failed', [
    //             'id' => $id,
    //             'error' => $e->getMessage(),
    //         ]);
    //         return null;
    ...
    //         });
    //     } catch (\Throwable $e) {
    //         Log::error('Rechargeervice findByAlias failed', [
    //             'alias' => $alias,
    //             'error' => $e->getMessage(),
    //         ]);
    //         return null;
    ...
    //     try {
    //         $all = Recharge::with(['admins', 'apis', 'socials', 'flags', 'settings'])->get();
    ...
    //         }
    //     } catch (\Throwable $e) {
    //         Log::error('Rechargeervice syncAll failed', [
    //             'error' => $e->getMessage(),
    //         ]);
    //     }
    // }
